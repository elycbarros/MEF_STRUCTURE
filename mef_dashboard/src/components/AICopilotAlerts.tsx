  ...
  if (!diagnosis || diagnosis.length === 0) {
    return (
      <div className="p-6 rounded-3xl border border-slate-200 bg-white shadow-sm flex flex-col items-center justify-center text-center space-y-3">
        <Sparkles className="w-8 h-8 text-blue-600 opacity-20" />
        <p className="text-xs font-bold text-slate-600">Nenhum diagnóstico AI disponível no momento.</p>
      </div>
    );
  }

  return (
    <div className="rounded-3xl border border-slate-200 bg-[#1a1c1e] p-6 shadow-2xl text-slate-900 overflow-hidden relative">
      {/* Background Glow */}
      ...
      <div className="space-y-4 relative z-10">
        ...
        {optimizationSuggestion && (
          <div className="p-5 rounded-2xl border-2 border-blue-500/50 bg-blue-500/10 shadow-[0_0_20px_rgba(59,130,246,0.2)] animate-in fade-in slide-in-from-bottom-2">
            <div className="flex items-center gap-2 mb-3">
              <Sparkles className="w-4 h-4 text-blue-600 fill-blue-400/20" />
              <span className="text-[10px] font-black uppercase tracking-widest text-blue-600">Generative Suggestion</span>
            </div>
            <p className="text-sm font-black italic text-slate-900 mb-4 leading-tight">
              "{optimizationSuggestion.explanation}"
            </p>
            <div className="grid grid-cols-2 gap-3 mb-4">
              <div className="p-2 bg-white/5 rounded-xl border border-slate-200 text-center">
                <p className="text-[8px] font-black text-slate-600 uppercase">Seção Sugerida</p>
              ...
              <div className="p-2 bg-emerald-500/10 rounded-xl border border-emerald-500/20 text-center">
                <p className="text-[8px] font-black text-emerald-600 uppercase">Redução de Peso</p>
                <p className="text-sm font-black text-emerald-600">-{formatNumberBR(optimizationSuggestion.weightReduction, 1)}%</p>
              </div>
            </div>
        ...
        {masterOpinion && (
          <div className={cn(
            ...
            <div className="flex gap-3">
              ...
              <div>
                <p className="text-[10px] font-black uppercase tracking-widest text-red-600 mb-1">Parecer Técnico Forense</p>
                <p className="text-sm font-black leading-tight text-slate-900 italic">
                  "{masterOpinion}"
                </p>
              </div>
            </div>
        ...
        <div className="pt-4 mt-2 border-t border-slate-200">
          <div className="flex items-center justify-between text-xs mb-2">
            ...
            <span className="font-black text-blue-600">{efficiencyScore}%</span>
          </div>
