...
export const academicBacklogSeed: BacklogItem[] = [
  ...
  {
    id: "escada-mestre",
    title: "Dimensionar escada no MESTRE",
    module: "Escada",
    outcome: "Percorrer o roteiro de cargas projetadas e dimensionamento a flexao.",
    tab: "especiais",
    priority: "Aula",
    status: "todo",
  },
  {
    id: "sapata-isolada",
    title: "Dimensionar sapata isolada",
    module: "Fundações",
    outcome: "Calcular base, rigidez e armadura de sapata centrada (NBR 6118/6122).",
    tab: "especiais",
    priority: "Aula",
    status: "todo",
  },
