...
"""
from radier_lab_v24 import LabConfig, run_deterministic_fem, _summarize_solver_result
from radier_solver_v2 import Material, Soil, PlateModel, RadierMindlinWinklerV2, write_example_column_csv
import numpy as np
...
def test_cracking_effect():
    ...
    solver = RadierMindlinWinklerV2(PlateModel(Lx=24, Ly=24, nx=15, ny=15, material=Material(E=32e9, nu=0.2, h=0.2), soil=Soil(kv=40e6)))
