...
import numpy as np
from lajes_solver import LajeModel, LajesMindlinSolver, SupportType
...
def test_rust_solver():
    ...
    print(
        f'   Python: Carga Total={res_py.distributed_load_total / 1000:.2f}kN, Reação={res_py.reactions_total / 1000:.2f}kN, Resíduo={res_py.residual / 1000:.4f}kN'
    )
    print(
        f'   Rust:   Carga Total={res_rs.distributed_load_total / 1000:.2f}kN, Reação={res_rs.reactions_total / 1000:.2f}kN, Resíduo={res_rs.residual / 1000:.4f}kN'
    )
