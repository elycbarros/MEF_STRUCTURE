...
import numpy as np
import pandas as pd
from radier_lab_v24 import PlateModel
from radier_solver_v2 import Material, RadierMindlinWinklerV2, Soil
...
def test_advanced_laje():
    ...
    pillars = [[2.0, 2.0, 50000], [8.0, 2.0, 50000], [8.0, 8.0, 50000], [2.0, 8.0, 50000]]
    ...
    res = solver.solve(
        column_loads=p_df.values, h_per_element=h_map, opening_mask=opening_mask, concrete_nonlinear=True
    )
