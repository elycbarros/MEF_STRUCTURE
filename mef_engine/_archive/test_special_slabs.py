...
from slab_lab import SlabConfig, SlabLab
...
def test_comparison():
    ...
    common = {
        ...
        'q_acid': 2.0,
        'nx': 15,
        'ny': 15,  # Malha rápida para teste
    }
    pillars = [
        PillarSupport('P1', 0.5, 0.5),
        PillarSupport('P2', 5.5, 0.5),
        PillarSupport('P3', 0.5, 5.5),
        PillarSupport('P4', 5.5, 5.5),
    ]
    ...
    cfg_ribbed = SlabConfig(
        base_name='test_ribbed', slab_type='ribbed', pillars=pillars, b_nerv=0.10, dist_nerv=0.50, h_mesa=0.05, **common
    )
    ...
    cfg_prest = SlabConfig(
        ...
        pillars=pillars,
        p_force=400.0,
        ecc=0.07,  # Valores fortes para ver o efeito
        **common,
    )
