...
class GeneticOptimizer:
    ...
    def __init__(
        ...
        self.prices = {'concrete': concrete_price_m3, 'steel': steel_price_kg, 'formwork': formwork_price_m2}
    ...
    def optimize_radier(self, area_m2: float, validation_fn: Callable[[float, float], dict]) -> Individual:
        """
...
if __name__ == '__main__':
    ...
    print('M5-MASTER OPTIMIZER RESULT:')
