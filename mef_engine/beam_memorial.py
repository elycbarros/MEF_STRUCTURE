...
from memorial_factory import build_unified_memorial, PLATFORM_VERSION
...
def build_beam_memorial(result: dict[str, Any], project_meta: dict[str, Any] | None = None) -> str:
    ...
    limitations = [
        "Nao considera efeitos de torcao",
        "Nao considera fadiga ou efeitos dinamicos"
    ]
