...
from schemas.common import AreaLoadInput, BeamInput, HoleInput, LineSupportInput, PillarInput
...
class ConfigInput(BaseModel):
    ...
    def validate_kv_units(cls, value: float) -> float:
        if value < 1.0e5:
            raise ValueError(
                'kv deve ser informado em N/m³; valores em kN/m³ ou MN/m³ sem conversão parecem incorretos'
            )
        return value
