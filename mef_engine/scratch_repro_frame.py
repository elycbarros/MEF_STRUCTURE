...
def test_frame_analyze():
        ...
        "members": [
            {
                ...
                "node_i": 1, 
                "node_j": 2, 
                "section": {"b": 0.2, "h": 0.5, "E": 2.5e10}
            }
        ],
        "loads": [
            {"node_id": 2, "Fx": 10.0, "Fy": 0.0, "Fz": 0.0, "Mx": 0.0, "My": 0.0, "Mz": 0.0}
        ],
        "supports": {
            "1": [0, 1, 2, 3, 4, 5]
        },
    ...
    try:
        ...
        from routes.mestre_frame import analyze_mestre_frame, MestreFrameRequest
