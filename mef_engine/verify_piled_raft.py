...
def test_piled_raft_validation():
    ...
    piles = [
        Pile(id="EST01", x=5.0, y=5.0, diameter_m=0.60, length_m=15.0, capacity_kN=1500.0, stiffness_kN_m=k_theoretical),
        Pile(id="EST02", x=15.0, y=5.0, diameter_m=0.60, length_m=15.0, capacity_kN=1500.0, stiffness_kN_m=k_theoretical),
        Pile(id="EST03", x=5.0, y=15.0, diameter_m=0.60, length_m=15.0, capacity_kN=1500.0, stiffness_kN_m=k_theoretical),
        Pile(id="EST04", x=15.0, y=15.0, diameter_m=0.60, length_m=15.0, capacity_kN=1500.0, stiffness_kN_m=k_theoretical),
    ]
